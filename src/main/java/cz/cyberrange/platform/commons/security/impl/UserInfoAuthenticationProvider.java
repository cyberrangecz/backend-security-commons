...
public class UserInfoAuthenticationProvider implements AuthenticationProvider {
  ...
  private TokenCache.TokenCacheItem validateToken(
      String bearerToken, Authentication authentication) {
  ...
  public Map<String, Object> modifyTimeClaims(Map<String, Object> parsedClaims) {
    ...
    Instant expiresAt =
        modifiedClaims.get("exp") != null ? ((Date) modifiedClaims.get("exp")).toInstant() : null;
    Instant issuedAt =
        modifiedClaims.get("iat") != null ? ((Date) modifiedClaims.get("iat")).toInstant() : null;
