...
import cz.muni.ics.kypo.commons.security.ClientConfigurationService;
import cz.muni.ics.kypo.commons.security.model.OAuth2AccessTokenImpl;
import cz.muni.ics.kypo.commons.security.model.UserInfo;
...
public class UserInfoTokenService implements ResourceServerTokenServices {
    ...
    private final Map<String, TokenCacheObject> authCache;
    ...
    private DecodedJWT decodeJWTAccessToken(String accessToken) {
        try {
            return com.auth0.jwt.JWT.decode(accessToken);
